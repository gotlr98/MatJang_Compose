...
android {
    ...
    defaultConfig {
        ...
        val restAppKey = localProperties.getProperty("KAKAO_REST_API_KEY")?:""

        buildConfigField("String", "KAKAO_REST_API_KEY", "\"$restAppKey\"")
        //manifest에서 사용
        manifestPlaceholders["KAKAO_REST_API_KEY"] = restAppKey
    }
